        ...
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          ...
          <div style={{ background: "#f6f5f3", padding: "2.5rem", borderRadius: "8px", borderLeft: `4px solid ${NAVY}` }} className="reveal">
            <p style={{ fontSize: "16px", color: "#333", lineHeight: 1.9, marginBottom: "1.25rem", fontStyle: "italic" }}>
              &ldquo;Mr. Speaker, Mr. Vice President, Members of Congress, and my fellow Americans: I stand before you tonight not as the leader of a party, but as a servant of a nation — the greatest nation the world has ever known. The state of our Union is tested, but I have seen the resilience of this people, and I am here to tell you: we are rising. We have been counted out before. We have faced enemies foreign and domestic, recessions and pandemics, division and doubt. And every single time, the American people have answered the call. Tonight, I come to this chamber not to declare victory, but to lay out the work that lies ahead — and to assure you that this administration will not flinch from it.
            </p>
            <p style={{ fontSize: "15px", color: "#444", lineHeight: 1.9, marginBottom: "1.25rem" }}>
              The first priority of this administration is the economic revival of the American worker. Our tax reform plan cuts rates for every family earning under $400,000 a year and eliminates the marriage penalty for good. Our trade policy will bring manufacturing home to Pennsylvania, Ohio, Wisconsin, and every state in this union. American energy independence — through oil, gas, nuclear, and homegrown innovation — will lower gas prices, cut utility bills, and create millions of high-paying jobs that cannot be outsourced. We will not apologize for producing American energy. We will be proud of it.
            </p>
            <p style={{ fontSize: "15px", color: "#444", lineHeight: 1.9, marginBottom: "1.25rem" }}>
              On the world stage, this administration has moved swiftly to restore the deterrence that was lost. We have rebuilt our relationships with our allies in NATO and the Pacific. We have made clear to every adversary — from Beijing to Moscow to Tehran — that American strength is not for sale and American resolve is not negotiable. Our military is the finest fighting force in the history of civilization, and we will keep it that way. Tonight I am announcing an increase in defense readiness funding that will ensure no adversary miscalculates the cost of challenging this nation or its partners.
            </p>
            <p style={{ fontSize: "15px", color: "#444", lineHeight: 1.9, marginBottom: "1.25rem" }}>
              We are also a nation of laws. The rule of law is not a slogan — it is the architecture of freedom. This administration will appoint judges who read the Constitution as it is written, not as they wish it to be. We will back our law enforcement officers with the resources and respect they have earned. We will end the selective enforcement of justice that has corroded public trust across the political spectrum. And we will protect the liberties enshrined in the Bill of Rights — every single one of them — against any power, including the executive branch, that would diminish them.
            </p>
            <p style={{ fontSize: "15px", color: "#444", lineHeight: 1.9, marginBottom: 0 }}>
              The American Dream was built by workers with calloused hands, by teachers who stayed late, by soldiers who never came home, and by parents who sacrificed everything so their children could have more. This administration will honor that legacy with action, not rhetoric. We will measure our success not in headlines, but in paychecks. Not in approval ratings, but in the safety of our streets and the strength of our families. The work is hard. The stakes are high. And we are ready. God bless you, God bless our troops, and God bless the United States of America.&rdquo;
            </p>
          </div>
        </div>
      </section>
